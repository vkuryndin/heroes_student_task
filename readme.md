...
- бой заканчивается, когда одна из сторон больше не имеет живых юнитов, способных сделать ход (или прогресса нет).
...
- После каждого раунда печатается:
    - `Round N is over!` + количество живых юнитов у каждой армии (как отладочный вывод, похожий на дефолтный).
